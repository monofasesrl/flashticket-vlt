/*
  ...
  1. New Tables
    - `tickets`
      - `id` (uuid, primary key)
      - `ticket_number` (text, unique) - Format: FM-YYYY-MM-NNNN
      - `description` (text)
      - `status` (enum)
      - `priority` (enum)
      - `customer_name` (text)
  ...
  3. Functions
    - `generate_ticket_number()` - Generates unique ticket numbers
    - `update_ticket_number()` - Trigger function to set ticket numbers
    - `insert_test_tickets()` - Function to insert test data
